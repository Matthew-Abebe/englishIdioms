...
namespace englishIdoms
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // This dictionary has a key of string and a value of List

            Dictionary<string, List<string>> idioms = new Dictionary<string, List<string>>();
            idioms.Add("Penny", new List<string> { "A", "penny", "for", "your", "thoughts" }); //This is a list.
            ...
            // The foreach loop runs over the KeyValuePairs of idioms

            foreach (KeyValuePair<string, List<string>> idi in idioms)
            {

                //The variable phrase is defined as a string

                string phrase = string.Join(" ", idi.Value);


                Console.WriteLine($"{idi.Key}: {phrase}");
            }
